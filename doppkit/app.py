...
@click.group()
@click.option('--token', envvar='GRID_ACCESS_TOKEN', help='GRiD access token. Use GRID_ACCESS_TOKEN environment variable to globally override', type=str)
@click.option('--url', envvar='GRID_BASE_URL', default="https://grid.nga.mil/grid", help='GRiD Instance URL. Use GRID_BASE_URL environment variable to gobally override')
...
@click.option('--overwrite', default=False, type=bool, help='Overwrite existing fetches of the same name')
